...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 22 May 2024, 14:01:15
...
-- Veritabanı: `car_wash`
--
CREATE DATABASE IF NOT EXISTS `car_wash` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `car_wash`;
...
INSERT INTO `reservations` (`id`, `user_id`, `reservation_date`, `reservation_time`, `is_accepted`) VALUES
(1, 1, '2024-05-24', '08:00:00', 0),
(2, 1, '2024-05-23', '12:00:00', 1);
...
CREATE TABLE `users` (
  ...
  `usertype` enum('normal','admin') DEFAULT 'normal'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `users` (`id`, `email`, `password`, `phone_number`, `name`, `usertype`) VALUES
(1, 'alp@a.com', '$2a$10$JP7x7y2ZJog79DgXzLzfwe8PVIG0P1K6ncRwarBlFESf2ReoWe2VO', '5454840824', 'alperen yilmaz', 'normal');
...
('root', '2024-05-22 12:01:09', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"tr\"}');
